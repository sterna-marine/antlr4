...
package ANTLR.Runtime.ErrorListener_Protocol is
   ...
   procedure syntaxError (This : ANTLRErrorListener;
                          ...
                          msg : UString;
                          e : Optional_AnyObject) is abstract;
   ...
   -- identified
   --
   procedure reportAmbiguity (This : ANTLRErrorListener;
                              recognizer : Parser;
                              dfa : DFA;
                              startIndex : Integer;
                              stopIndex : Integer;
   ...
   -- detected
   --
   procedure reportAttemptingFullContext (This : ANTLRErrorListener;
                                          recognizer : Parser;
                                          dfa : DFA;
                                          startIndex : Integer;
                                          stopIndex : Integer;
   ...
   -- was determined
   --
   procedure reportContextSensitivity (This : ANTLRErrorListener;
                                       recognizer : Parser;
                                       dfa : DFA;
                                       startIndex : Integer;
                                       stopIndex : Integer;
...
end ANTLR.Runtime.ErrorListener_Protocol;
