...
type IntSet is interface;
    ...
    -- empty result set.
    --
    function or (a : IntSet) return IntSet
    ...
    --
    function size (This : …) return Integer;
    ...
    -- `False`.
    --
    function isnull (This : …) return Boolean;
    ...
    -- otherwise, returns _org.antlr.v4.runtime.Token#INVALID_TYPE_.
    --
    function getSingleElement (This : …) return Integer;
    ...
    --
    function toList (This : …) return Int_Container.Vector
end if;
