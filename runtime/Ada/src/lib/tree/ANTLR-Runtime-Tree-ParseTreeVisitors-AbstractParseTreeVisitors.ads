...
package ANTLR.Runtime.Tree.ParseTreeVisitors.AbstractParseTreeVisitors is
   ...
   -- public
   overriding
   procedure Initialize (Self : in out AbstractParseTreeVisitor);
   ...
   --open
   overriding
   function visit (This : AbstractParseTreeVisitor; tree : ParseTree) return Optional_T;
   ...
   --open
   overriding
   function visitChildren (This : AbstractParseTreeVisitor; node : RuleNode) return Optional_T;
   ...
   --open
   overriding
   function visitTerminal (This : AbstractParseTreeVisitor; node : TerminalNode) return Optional_T;
   ...
   -- open
   overriding
   function visitErrorNode (This : AbstractParseTreeVisitor; node : ErrorNode) return Optional_T;
