...
package ANTLR.Runtime.Parser is
   ...
   -- public
   function inContext (This : Parser; context : String) return Boolean
...
--	}
   ...
   -- public
   function getRuleIndex (This : Parser; ruleName : String) return Integer
      is (getRuleIndexMap ()[ruleName] ?? -1);

   -- public
   function getRuleContext () return Optional_ParserRuleContext
      is This._ctx;
   ...
   -- public
   function getSourceName (This : Parser) return String
