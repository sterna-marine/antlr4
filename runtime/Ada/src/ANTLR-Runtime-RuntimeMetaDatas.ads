...
package ANTLR.Runtime.RuntimeMetaDatas is
   ...
   -- public
   type RuntimeMetaData is record
      --
      ...
      --
      -- public static
      VERSION : UString := "4.13.2"; -- constant
   end record;
   ...
   -- public static
   function getRuntimeVersion return UString
      is (RuntimeMetaData.VERSION);
   ...
   --
   -- public static
   function getMajorMinorVersion (version : UString) return UString;
