...
type Tree is interface;
    ...
    --
    function getParent (This : …) return Tree?
    ...
    -- object.
    --
    function getPayload (This : …) return AnyObject
    ...
    --
    function getChildCount (This : …) return Integer;

    -- Print out a whole tree, not just a node, in LISP format
    -- `(root child1 .. childN)`. Print just a node if this is a leaf.
    --
    function toStringTree (This : …) return UString
