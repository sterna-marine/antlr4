...
type ParseTreePattern is new Ada.Finalization.Controlled record
    ...
    --
    -- public
    procedure Initialize (Self : in out …; matcher : ParseTreePatternMatcher;
                pattern : UString; patternRuleIndex : Integer; patternTree : ParseTree) {
...
begin
    ...
    -- public
    function getPattern (This : …) return UString is
begin
        return pattern
    end if;
