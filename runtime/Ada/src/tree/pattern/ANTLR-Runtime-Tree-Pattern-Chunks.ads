...
package ANTLR.Runtime.Tree.Pattern.Chunks is
   ...
   -- public
   function is_Equal (This : Chunk; other : Chunk) return Boolean
      is This === other;

   -- public static
   function "=" (Lhs, Rhs : Chunk) return Boolean
      is is_Equal (Lhs., rhs);

end ANTLR.Runtime.Tree.Pattern.Chunks;
