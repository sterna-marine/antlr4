...
type PredictionMode is (
    ...
    -- 
    public static function hasSLLConflictTerminatingPrediction (mode : PredictionMode;configs : ATNConfigSet) return Boolean is
begin
        var configs := configs
        -- 
...
begin
    ...
    -- consumed at this point. The conflicting sets us : constant to strip away
    ...
    -- 
    public static function resolvesToJustOneViableAlt (altsets : [BitSet]) return Integer is
begin
...
begin
    ...
    -- - parameter altsets: a collection of alternative subsets
    -- 
    public static function getUniqueAlt (altsets : [BitSet]) return Integer is
begin
    ...
    -- 
    public static function getAlts (altsets : Array<BitSet>) return BitSet is
begin
    ...
    -- 
    public static function getAlts (configs : ATNConfigSet) return BitSet is
begin
    ...
    public static function getConflictingAltSubsets (configs : ATNConfigSet) return [BitSet] {
        return configs.getConflictingAltSubsets()
    end ;

    public static function hasStateAssociatedWithOneAlt (configs : ATNConfigSet) return Boolean is
begin
