...
package ANTLR.Runtime.ATN.PredictionModes is
   ...
   --
   -- public static
   function hasSLLConflictTerminatingPrediction (mode : PredictionMode; configs : ATNConfigSet) return Boolean;
   ...
   --
   -- public static
   function hasConfigInRuleStopState (configs : ATNConfigSet) return Boolean
      is (configs.hasConfigInRuleStopState);
   ...
   --
   -- public static
   function allConfigsInRuleStopStates (configs : ATNConfigSet) return Boolean
      is (configs.allConfigsInRuleStopStates);
   ...
   --
   --
   -- map.Element (c) U= c._org.antlr.v4.runtime.atn.ATNConfig#alt alt_ # map hash/equals uses s and x, not
   -- alt and not pred
   --
   --
