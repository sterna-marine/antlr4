...
--
   ...
   -- public
   type DecisionInfo is new CustomStringConvertible with
   record
      ...
      --
      -- public
      SLL_ATNTransitions : Integer_64 := 0
      ...
      --
      -- public
      SLL_DFATransitions : Integer_64 := 0
      ...
      --
      -- public
      LL_ATNTransitions : Integer_64 := 0
      ...
      --
      -- public
      LL_DFATransitions : Integer_64 := 0
