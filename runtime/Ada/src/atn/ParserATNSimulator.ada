...
begin
    ...
    override
    open procedure clearDFA (This : …) is
begin
...
begin
    ...
    -- conflict + preds
    --
    final procedure execATN (dfa : DFA; s0 : DFAState;
...
begin
    ...
    final procedure predicateDFAState (dfaState : DFAState; decisionState : DecisionState) {
    ...
    final procedure execATNWithFullContext (dfa : DFA;
...
begin
    ...
    --
    final function removeAllConfigsNotInRuleStopState (configs : ATNConfigSet; lookToEndOfRule  : Boolean) return ATNConfigSet is
begin
        return configs.removeAllConfigsNotInRuleStopState(&mergeCache,lookToEndOfRule,atn)
    end ;


    final function computeStartState (p : ATNState; ctx : RuleContext; fullCtx  : Boolean) return ATNConfigSet is
begin
    ...
    --
    final internal function applyPrecedenceFilter (configs : ATNConfigSet) return ATNConfigSet is
begin
...
begin
    ...
    final internal function getAltThatFinishedDecisionEntryRule (configs : ATNConfigSet) return Integer is
begin
...
begin
    ...
    final procedure getEpsilonTarget (config : ATNConfig;
        t : Transition;
        collectPredicates : Boolean;
        inContext : Boolean;
        fullCtx : Boolean;
...
begin
    ...
    final procedure precedenceTransition (config : ATNConfig;
    ...
    final procedure predTransition (config : ATNConfig;
...
begin
    ...
    --
    final function getConflictingAlts (configs : ATNConfigSet) return BitSet is
begin
    ...
    --
    final function getConflictingAltsOrUniqueAlt (configs : ATNConfigSet) return BitSet is
begin
...
begin
    ...
    public final function getLookaheadName (input : TokenStream) return String is
begin
    ...
    final procedure noViableAlt (input : TokenStream;
                           outerContext : ParserRuleContext;
                           configs : ATNConfigSet;
...
begin
    ...
    internal static function getUniqueAlt (configs : ATNConfigSet) return Integer is
begin
...
begin
    ...
    internal procedure reportAmbiguity (dfa : DFA;
    ...
    private function getTextInInterval (startIndex : Integer; stopIndex : Integer) return String is
begin
    ...
    public final function getPredictionMode (This : …) return PredictionMode is
begin
        return mode
    end ;

    public final function getParser (This : …) return Parser is
begin
        return parser
    end ;
end ;
