...
package body ANTLR.Runtime.ATN.LookupDictionaries is
   ...
   -- Hashed_Map
   --  subtype Ada.Containers.Hash_Type is Ada.Containers.Hash_Type;

-- private
-- function Hash_ATNConfig (Key : ATNConfig) return Ada.Containers.Hash_Type is --TOFIX
   --  function hash (Key : ATNConfig) return Ada.Containers.Hash_Type is --TOFIX
   ...
   function Equivalent_Keys (Left, Right : Ada.Containers.Hash_Type) return Boolean
   ...
   package Hashed_ATNConfig is new Ada.Containers.Hashed_Maps (
   ...
   function getOrAdd (This : in out LookupDictionary; config : ATNConfig) return ATNConfig is --TOFIX
      h : constant Ada.Containers.Hash_Type := hash (config);
