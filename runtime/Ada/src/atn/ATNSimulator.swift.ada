...
begin
    ...
    open function getSharedContextCache (This : …) return PredictionContextCache is
begin
        return sharedContextCache
    end ;

    open function getCachedContext (context : PredictionContext) return PredictionContext is
begin
