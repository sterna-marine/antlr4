...
package body ANTLR.Runtime.ATN.CommonUtil is
   ...
   function toLong (data : Character.Container.Vector; offset : Integer) return Integer_64 is --TOFIX
   ...
   function toUUID (data : Character.Container.Vector; offset : Integer) return UUID is --TOFIX
