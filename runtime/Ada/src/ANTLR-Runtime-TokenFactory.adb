...
type TokenFactory is interface;
   ...
   begin
    -- Generically useful
    function create (Type : Token_Kind; text : UString) return Token
...
type TokenSourceAndStream is new Ada.Finalization.Controlled record
    ...
    -- public
    procedure Initialize (Self : in out …; tokenSource : Optional_TokenSource; := (Valid => False), stream : Optional_CharStream; := (Valid => False)) {
