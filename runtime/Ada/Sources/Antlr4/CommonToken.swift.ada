...
public type CommonToken is new WritableToken with null record;
{
    ...
    public init(source : TokenSourceAndStream; type : Integer; channel : Integer; start : Integer; stop : Integer) {
        self.source := source
        self.type := type
    ...
    -- 
    public init(type : Integer; text : String?) {
        self.type := type
