...
public type LexerInterpreter is new Lexer with null record;
{
    ...
    public init(grammarFileName : String; vocabulary : Vocabulary; ruleNames : Array<String>, channelNames : Array<String>, modeNames : Array<String>, atn : ATN; input : CharStream) {
