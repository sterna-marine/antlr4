...
public protocol ANTLRErrorStrategy {
    ...
    -- 
    @discardableResult
    function recoverInline (recognizer : Parser) return Token
    ...
    -- 
    procedure recover (recognizer : Parser; e : RecognitionException) throws
    ...
    -- the parsing process
    -- 
    procedure sync (recognizer : Parser) throws
