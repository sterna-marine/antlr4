...
open type LexerATNSimulator is new ATNSimulator with null record;
{
    ...
    internal class SimState {
        internal var index: Integer := -1
        internal var line: Integer := 0
        internal var charPos: Integer := -1
        internal var dfaState: DFAState?

        internal procedure reset (This : …) is
begin
            index := -1
            line := 0
            charPos := -1
    ...
    public convenience init(atn : ATN; decisionToDFA : [DFA],
        sharedContextCache : PredictionContextCache) {
            self.init(null, atn, decisionToDFA, sharedContextCache)
    end ;

    public init(recog : Lexer?, atn : ATN;
        decisionToDFA : [DFA],
        sharedContextCache : PredictionContextCache) {
    ...
    open procedure copyState (simulator : LexerATNSimulator) {
    ...
    open function match (input : CharStream; mode : Integer) return Integer is
begin
        self.mode := mode
...
begin
    ...
    internal function execATN (input : CharStream; ds0 : DFAState) return Integer is
begin
...
begin
    ...
    internal procedure failOrAccept (prevAccept : SimState; input : CharStream;
...
begin
    ...
    -- parameter.
    --
    internal procedure getReachableConfigSet (input : CharStream; closureConfig : ATNConfigSet; reach : ATNConfigSet; t : Integer) {
    ...
    final procedure computeStartState (input : CharStream;
...
begin
    ...
    final procedure getEpsilonTarget (input : CharStream;
...
begin
    ...
    final procedure captureSimState (settings : SimState;
        input : CharStream;
        dfaState : DFAState) {
...
begin
    ...
    final function addDFAState (configs : ATNConfigSet) return DFAState is
begin
        --
    ...
    public final function getDFA (mode : Integer) return DFA is
begin
    ...
    public function getText (input : CharStream) return String is
begin
...
begin
    ...
    public procedure consume (input : CharStream) {
        curChar : constant := try input.LA(1)
