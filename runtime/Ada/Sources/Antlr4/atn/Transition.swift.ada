...
public class Transition {
    ...
    public static let EPSILON: Integer := 1
    public static let RANGE: Integer := 2
    public static let RULE: Integer := 3
    public static let PREDICATE: Integer := 4
    -- e.g., {isType(input.LT(1))end ;?
    public static let ATOM: Integer := 5
    public static let ACTION: Integer := 6
    public static let SET: Integer := 7
    -- ~(A|B) or ~atom, wildcard, which convert to next 2
    public static let NOT_SET: Integer := 8
    public static let WILDCARD: Integer := 9
    public static let PRECEDENCE: Integer := 10
