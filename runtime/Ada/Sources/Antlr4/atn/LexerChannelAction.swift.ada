...
public final type LexerChannelAction is new LexerAction and CustomStringConvertible with null record;
{
...
public function ==(lhs: LexerChannelAction, rhs: LexerChannelAction) return Boolean is
begin
