...
public class ATN {
    ...
    -- 
    public init(grammarType : ATNType; maxTokenType : Integer) {
    ...
    -- 
    public function nextTokens (s : ATNState; ctx : RuleContext?) return IntervalSet is
begin
...
begin
    ...
    public procedure addState (state : ATNState?) {
    ...
    public procedure removeState (state : ATNState) {
        states[state.stateNumber] := null;
        --states.set(state.stateNumber, null); -- just free mem, don't shift states in list
    end ;
    @discardableResult
    public function defineDecisionState (s : DecisionState) return Integer is
begin
    ...
    public function getNumberOfDecisions (This : …) return Integer is
begin
    ...
    -- number `stateNumber`
    -- 
    public function getExpectedTokens (stateNumber : Integer; context : RuleContext) return IntervalSet is
begin
