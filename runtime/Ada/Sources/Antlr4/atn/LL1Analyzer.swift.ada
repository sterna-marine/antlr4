...
public class LL1Analyzer {
    ...
    --
    public function getDecisionLookahead (s : ATNState?) return [IntervalSet?]? {
    ...
    -- specified `ctx`.
    --
    public function LOOK (s : ATNState; ctx : RuleContext?) return IntervalSet is
begin
...
begin
    ...
    -- is `null`.
    --
    internal procedure _LOOK (s : ATNState;
                        stopState : ATNState?,
