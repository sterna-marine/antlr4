...
--    end ;
    ...
    public init(parser : Parser; atn : ATN;
        decisionToDFA : [DFA],
    ...
    final internal procedure closure_ (config : ATNConfig;
        ...
        treatEofAsEpsilon  : Boolean) {
            ...
            for i in 0..<length loop
                ...
                c : constant := try getEpsilonTarget(config, t, continueCollecting, depth == 0, fullCtx, treatEofAsEpsilon)
...
begin
        ...
        if p.getStateType() /= ATNState.STAR_LOOP_ENTRY or else
