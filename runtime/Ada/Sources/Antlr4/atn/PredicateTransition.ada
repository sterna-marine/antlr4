...
public final type PredicateTransition is new AbstractPredicateTransition and CustomStringConvertible with null record;
{
    ...
    public init(target : ATNState; ruleIndex : Integer; predIndex : Integer; isCtxDependent  : Boolean) {
...
begin
    ...
    public function getPredicate () return SemanticContext.Predicate {
