...
public class ParseInfo {
    ...
    -- 
    public function getLLDecisions () return Array<Int> {
    ...
    -- 
    public function getTotalTimeInPrediction (This : …) return Int64 is
begin
        let decisions: [DecisionInfo] := atnSimulator.getDecisionInfo()
        var t: Int64 := 0
    ...
    -- 
    public function getTotalSLLLookaheadOps (This : …) return Int64 is
begin
        let decisions: [DecisionInfo] := atnSimulator.getDecisionInfo()
        var k: Int64 := 0
        for d in decisions loop
    ...
    -- 
    public function getTotalLLLookaheadOps (This : …) return Int64 is
begin
        let decisions: [DecisionInfo] := atnSimulator.getDecisionInfo()
        var k: Int64 := 0
        for d in decisions loop
    ...
    -- 
    public function getTotalSLLATNLookaheadOps (This : …) return Int64 is
begin
        let decisions: [DecisionInfo] := atnSimulator.getDecisionInfo()
        var k: Int64 := 0
        for d in decisions loop
    ...
    -- across all decisions made during parsing.
    -- 
    public function getTotalLLATNLookaheadOps (This : …) return Int64 is
begin
        let decisions: [DecisionInfo] := atnSimulator.getDecisionInfo()
        var k: Int64 := 0
        for d in decisions loop
    ...
    -- 
    public function getTotalATNLookaheadOps (This : …) return Int64 is
begin
        let decisions: [DecisionInfo] := atnSimulator.getDecisionInfo()
        var k: Int64 := 0
        for d in decisions loop
    ...
    -- 
    public function getDFASize (This : …) return Integer is
begin
        var n: Integer := 0
    ...
    -- particular decision.
    -- 
    public function getDFASize (decision : Integer) return Integer is
begin
