...
public final type LexerIndexedCustomAction is new LexerAction with null record;
{
    ...
    -- 
    public init(offset : Integer; action : LexerAction) {
        self.offset := offset
        self.action := action
    end ;
    ...
    -- 
    public function getOffset (This : …) return Integer is
begin
        return offset
    end ;
    ...
    -- 
    public function getAction (This : …) return LexerAction is
begin
        return action
    end ;
