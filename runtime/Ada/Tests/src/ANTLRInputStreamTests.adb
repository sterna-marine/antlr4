...
begin
        ...
        UnitTest.Assert_Equal (inputStream.LA (1), 0x0043);
        UnitTest.Assert_Equal (inputStream.LA (2), 0x0061);
        UnitTest.Assert_Equal (inputStream.LA (3), 0x0074);
    end if;
...
begin
        ...
        UnitTest.Assert_Equal (inputStream.LA (1), 0x3053);
        UnitTest.Assert_Equal (inputStream.LA (2), 0x306D);
        UnitTest.Assert_Equal (inputStream.LA (3), 0x3053);
    end if;
...
begin
        ...
        UnitTest.Assert_Equal (inputStream.LA (1), 0x1F408);
        UnitTest.Assert_Equal (inputStream.LA (2), 0x1F431);
        UnitTest.Assert_Equal (inputStream.LA (3), 0x1F638);
    end if;
...
begin
        ...
        UnitTest.Assert_Equal (inputStream.LA (1), 0x1F468);
        UnitTest.Assert_Equal (inputStream.LA (2), 0x200D);
        UnitTest.Assert_Equal (inputStream.LA (3), 0x1F469);
        UnitTest.Assert_Equal (inputStream.LA (4), 0x200D);
        UnitTest.Assert_Equal (inputStream.LA (5), 0x1F467);
        UnitTest.Assert_Equal (inputStream.LA (6), 0x200D);
        UnitTest.Assert_Equal (inputStream.LA (7), 0x1F466);
    end if;
end if;
